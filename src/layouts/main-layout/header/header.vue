    ...
    <div class="container">
      ...
      <div id="navigation">
        ...
        <ul class="navigation-menu nav-light nav-right">
          <li>
            <a href="index-real-estate.html" class="sub-menu-item">Home</a>
          </li>
          ...
          <li class="has-submenu parent-menu-item">
            ...
            <ul class="submenu">
              <li>
                <a href="property-grid.html" class="sub-menu-item"
                  >Grid Listing</a
                >
              </li>
              <li>
          ...
          <li class="has-submenu parent-menu-item">
            ...
            <ul class="submenu">
              <li>
                <a href="property-aboutus.html" class="sub-menu-item"
                  >About Us</a
                >
              </li>
              <li>
                <a href="property-features.html" class="sub-menu-item"
                  >Features</a
                >
              </li>
              <li class="has-submenu parent-menu-item">
                ...
                <ul class="submenu">
                  ...
                  <li>
                    <a
                      href="helpcenter-support-request.html"
                      class="sub-menu-item"
                      >Support</a
                    >
                  </li>
          ...
          <li>
            <a href="page-contact-one.html" class="sub-menu-item">Contact us</a>
          </li>
        </ul>
        <!--end navigation menu-->
      </div>
